                        ...
                        if tipo_carro == 1:
                            ...
                            if guincho_escolha == 1:
                                ...
                                #CASO ELE SAIBA DE ALGUMA INFORMAÇÃO
                                    ...
                                    print(f"Obrigade pelas informações. Iremos tentar enviar o guincho que mais se encaixa com a suas especificacoes. Atendimento para o veiculo pesado de placa: {veic} do propietário de CPF: {cpf} está sendo enviado para o endereco {end_pesado}")
                                    deseja_cont_pesado_transito_nao_sabe = input("Encerrar atendimento? (1) para SIM e (2) para NAO")
                                    while deseja_cont_pesado_transito_nao_sabe == 1:
                                        print("FIM DO ATENDIMENTO")
                                    break
